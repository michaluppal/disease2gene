...
true ? Slide.propTypes = {
   ...
   */
  container: chainPropTypes(import_prop_types13.default.oneOfType([HTMLElementType, import_prop_types13.default.func]), (props) => {
    if (props.open) {
   ...
   * @default 'down'
   */
  direction: import_prop_types13.default.oneOf(["down", "left", "right", "up"]),
  /**
   * The transition timing function.
   * You may specify a single easing or a object containing enter and exit values.
   * @default {
...
var Drawer = React16.forwardRef(function Drawer2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDrawer"
  });
  ...
  const mounted = React16.useRef(false);
  React16.useEffect(() => {
...
true ? Drawer.propTypes = {
   ...
   * @default 'left'
   */
  anchor: import_prop_types15.default.oneOf(["bottom", "left", "right", "top"]),
  /**
   * @ignore
   */
   ...
   * @default {}
   */
  ModalProps: import_prop_types15.default.object,
  /**
   * Callback fired when the component requests to be closed.
   * The `reason` parameter can optionally be used to control the response to `onClose`.
   *
   ...
   */
  SlideProps: import_prop_types15.default.object,
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types15.default.shape({
    ...
    docked: import_prop_types15.default.oneOfType([import_prop_types15.default.func, import_prop_types15.default.object]),
  ...
  slots: import_prop_types15.default.shape({
    ...
    docked: import_prop_types15.default.elementType,
   ...
   * @default 'temporary'
   */
  variant: import_prop_types15.default.oneOf(["permanent", "persistent", "temporary"])
} : void 0;
...
//# sourceMappingURL=chunk-LP4NRWLG.js.map
